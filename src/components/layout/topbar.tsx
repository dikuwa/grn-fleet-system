...
export function Topbar({
  ...
  const attentionCount = notificationQuery.data?.attentionCount || 0;
    ...
    <header className="border-border bg-surface/95 pt-safe sticky top-0 z-30 flex min-h-16 items-center gap-2 border-b px-3 backdrop-blur min-[360px]:gap-3 min-[360px]:px-4 md:gap-4 md:px-6">
      ...
      <div className="ml-auto flex items-center gap-1">
        ...
        <Link
          ...
          aria-label={`Notifications${attentionCount > 0 ? ` (${attentionCount} requiring attention)` : ''}`}
        >
          ...
          {attentionCount === 0 && !notificationQuery.isError && (
        ...
        <div className="relative" ref={accountRef}>
          ...
          >
            ...
            <span className="hidden max-w-[150px] min-w-0 flex-col items-start leading-tight sm:flex">
              <span className="text-ink-700 w-full truncate text-[13px] font-medium">
                {displayName}
              </span>
          ...
          {showAccountMenu && (
            ...
            >
              ...
              <div className="mt-1 space-y-0.5">
                ...
                <Link
                  href="/dashboard/switch-organisation"
                  className={menuItemClass}
                  onClick={() => setShowAccountMenu(false)}
                  role="menuitem"
                >

...
const migration = readFileSync(
  resolve(process.cwd(), 'src/db/migrations/0120_notification_dedupe_tenant_scope.sql'),
  'utf8',
);
...
describe('notification dedupe tenant-scope migration', () => {
  ...
  it('keeps all notification writers compatible with the tenant-scoped index', () => {

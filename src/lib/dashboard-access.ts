...
export const routeRegistry: readonly RouteDefinition[] = [
  ...
  },
  {
    ...
    section: 'Overview',
    workspaces: [W.TENANT_ADMIN],
    access: { [W.TENANT_ADMIN]: tenantManage(['view', 'update']) },
    tenantScoped: true,
    order: 15,
    navigationVisible: false,
    directUrlBehaviour: '403',
  },
  {
    id: 'platform',
  ...
  },
  {
    ...
    path: '/dashboard/platform/demo-requests',
    label: 'Demo Requests',
    icon: 'MonitorPlay',
    section: 'Platform',
    workspaces: [W.PLATFORM_ADMIN],
  ...
  {
    id: 'platform-billing',
    path: '/dashboard/platform/billing',

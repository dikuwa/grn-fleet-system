...
/**
 * Hardened standalone receipt scan used by the fuel-entry review flow.
 * Keeps OCR provisional and never verifies a fuel transaction.
 */
  ...
  try {
    ...
    if (aiExtraction) {
      ...
      try {
        ...
        console.warn('[fuel/receipts/scan-v2] OCR failed:', ocrError);
      }
    }
    ...
    console.error('[fuel/receipts/scan-v2] POST failed:', error);

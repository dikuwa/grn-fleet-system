...
import { requestScopeCondition, vehicleScopeCondition } from '@/lib/record-scope';
        ...
        .where(
          and(
            ...
            requestScopeCondition({
              ...
              recordScope: requestAccess.recordScope ?? 'self',
            }),
            or(
        ...
        .where(
          and(
            ...
            vehicleScopeCondition({
              tenantId: session.tenantId,
              userId: session.user.id,
              recordScope: vehicleAccess.recordScope ?? 'assigned',
            }),

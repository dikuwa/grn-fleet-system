    ...
    >
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input id="contact-name" name="name" type="text" required autoComplete="name" maxLength={120} className={inputCls} placeholder="Your name" />
        </div>
        <div>
          <label htmlFor="contact-email" className={labelCls}>Email *</label>
          <input id="contact-email" name="email" type="email" required autoComplete="email" maxLength={254} className={inputCls} placeholder="you@organisation.na" />
        </div>
      </div>
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input id="contact-phone" name="phone" type="tel" autoComplete="tel" maxLength={40} className={inputCls} placeholder="+264 61 123 4567" />
        </div>
        <div>
          <label htmlFor="contact-subject" className={labelCls}>Subject *</label>
          <input id="contact-subject" name="subject" type="text" required maxLength={200} className={inputCls} placeholder="How can we help?" />
        </div>
      </div>
      <div className="mt-4">
        ...
        <textarea
          ...
          required
          maxLength={5000}
          className="w-full resize-none rounded-[8px] border border-border bg-canvas px-3 py-2 text-sm text-ink-950 placeholder:text-ink-400 focus:outline-none focus:ring-2 focus:ring-brand-600"
          placeholder="Your message..."
        />
      </div>

      {error && (
        <p role="alert" className="mt-4 rounded-[8px] bg-status-error-bg px-3 py-2 text-sm text-status-error-text">
          {error}
        </p>
      )}

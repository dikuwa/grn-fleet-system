          ...
          <CardContent className="pt-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Field label="Transmission">
                <StyledSelect value={form.transmission} onChange={(e) => update({ transmission: e.target.value })}>
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Field label="Status">
                <StyledSelect value={form.status} onChange={(e) => update({ status: e.target.value })}>
